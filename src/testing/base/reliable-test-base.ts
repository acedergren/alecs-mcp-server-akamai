...
import { EnhancedEdgeGridMock } from '../mocks/enhanced-edgegrid-mock';
...
export class ReliableTestBase {
  protected mockEdgeGrid: EnhancedEdgeGridMock;
  ...
  async setupTest(): Promise<void> {
    ...
    this.mockEdgeGrid = new EnhancedEdgeGridMock();
 ...
 */
export class UnitTestBase extends ReliableTestBase {
  constructor() {
    super({
      mockLevel: 'complete',
      timeout: 5000,
 ...
 */
export class IntegrationTestBase extends ReliableTestBase {
  constructor() {
    super({
      mockLevel: 'external',
      timeout: 15000,
 ...
 */
export class ContractTestBase extends ReliableTestBase {
  constructor() {
    super({
      mockLevel: 'minimal',
      timeout: 10000,
