 ...
 * 
 * Tests the integration of ID translation service with BaseTool
 */

import { BaseTool } from '../tools/common/base-tool';
...
describe('ID Translation Integration', () => {
  ...
  describe('BaseTool.execute with translation', () => {
  ...
  describe('Common translation mappings', () => {
    ...
    it('should have mappings for all domains', () => {
      const domains = Object.keys(BaseTool.COMMON_TRANSLATIONS);
    ...
    it('should have correct types for each mapping', () => {
      for (const [, mappings] of Object.entries(BaseTool.COMMON_TRANSLATIONS)) {
