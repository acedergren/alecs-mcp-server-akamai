...
export class PropertyOnboardingAgent {
  ...
  async execute(config: OnboardingConfig): Promise<OnboardingResult> {
    ...
    try {
      ...
      console._error('[PropertyOnboarding] Error:', _error);
      result.errors!.push(
  ...
  private async createCPCodeForProperty(config: Required<OnboardingConfig>): Promise<{
    ...
    try {
      ...
      console._error('[PropertyOnboarding] Create CP Code error:', _error);
      return { success: false };
    }
  }
  ...
  private async createPropertyWithRetry(config: Required<OnboardingConfig>): Promise<{
    ...
    try {
      ...
      console._error('[PropertyOnboarding] Create property error:', _error);
      return { success: false };
    }
  }
  ...
  private async createEdgeHostnameWithRetry(
    ...
    try {
      ...
      console._error('[PropertyOnboarding] Create edge hostname error:', _error);
      return { success: false };
    }
  }
  ...
  private async handleDnsSetup(
    ...
    try {
      ...
      console._error('[PropertyOnboarding] DNS setup error:', _error);
      return {
        recordCreated: false,
  ...
  private async createAcmeChallengeRecords(
    ...
    try {
      ...
      console._error('[PropertyOnboarding] ACME record creation error:', _error);
    }
  }
  ...
  private async activatePropertyToStaging(
    ...
    try {
      ...
      console._error('[PropertyOnboarding] Activation error:', _error);
      return { success: false };
    }
  }
