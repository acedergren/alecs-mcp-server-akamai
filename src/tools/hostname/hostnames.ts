 ...
 */
export class HostnameOperations extends AkamaiOperation {
      ...
      async () => {
        ...
        for (const hostname of params.hostnames) {
          ...
          if (params.validationChecks.includes('conflict')) {
            ...
            const hasConflicts = conflictContent && conflictContent.type === 'text' && conflictContent.text ? 
...
export const hostnameOperations = new HostnameOperations();
export const hostnameTools = hostnameOperations; // @deprecated - use hostnameOperations