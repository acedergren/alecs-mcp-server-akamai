  ...
  getAllSecurityTools(): Record<string, any> {
    return {
      ...
      'security.waf.policy.create': {
        ...
        handler: async (_client: any, args: any) => this.createWAFPolicy(args)
      },
      'security.waf.policy.list': {
        description: 'List all WAF security policies in configuration',
        inputSchema: ConfigVersionSchema,
        handler: async (_client: any, args: any) => this.listResource('security-policies', args)
      },
      'security.waf.policy.get': {
        description: 'Get specific WAF security policy details',
        inputSchema: PolicyContextSchema,
        handler: async (_client: any, args: any) => this.getResource(`security-policies/${args.policyId}`, args)
      },
      'security.waf.policy.update': {
        ...
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}`, args)
      },
      'security.waf.policy.delete': {
        description: 'Delete WAF security policy',
        inputSchema: PolicyContextSchema,
        handler: async (_client: any, args: any) => this.deleteResource(`security-policies/${args.policyId}`, args)
      },
      'security.waf.attack-group.configure': {
        ...
        handler: async (_client: any, args: any) => this.configureWAFAttackGroup(args)
      },
      'security.waf.attack-group.list': {
        description: 'List all WAF attack groups for policy',
        inputSchema: PolicyContextSchema,
        handler: async (_client: any, args: any) => this.listResource(`security-policies/${args.policyId}/waf-protection/attack-groups`, args)
      },
      'security.waf.rule.configure': {
        description: 'Configure individual WAF rule actions',
        inputSchema: WAFRuleActionSchema,
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/waf-protection/rules/${args.ruleId}`, args)
      },
      'security.waf.rule.list': {
        description: 'List all available WAF rules',
        inputSchema: PolicyContextSchema,
        handler: async (_client: any, args: any) => this.listResource(`security-policies/${args.policyId}/waf-protection/rules`, args)
      },
      'security.waf.evaluation.configure': {
        description: 'Configure WAF evaluation order and timing',
        inputSchema: WAFEvaluationSchema,
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/waf-protection/evaluation`, args)
      },
      ...
      'security.bot.configure': {
        ...
        handler: async (_client: any, args: any) => this.configureBotManagement(args)
      },
      'security.bot.category.list': {
        description: 'List all bot categories and their actions',
        inputSchema: PolicyContextSchema,
        handler: async (_client: any, args: any) => this.listResource(`security-policies/${args.policyId}/bot-management/bot-category-actions`, args)
      },
      'security.bot.category.configure': {
        description: 'Configure specific bot category action',
        inputSchema: BotCategorySchema,
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/bot-management/bot-category-actions/${args.categoryId}`, args)
      },
      'security.bot.detection.configure': {
        description: 'Configure bot detection overrides',
        inputSchema: BotDetectionOverrideSchema,
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/bot-management/bot-detection-actions/${args.detectionId}`, args)
      },
      'security.bot.analytics.configure': {
        description: 'Configure bot analytics and tracking',
        inputSchema: BotAnalyticsSchema,
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/bot-management/bot-analytics-cookie`, args)
      },
      ...
      'security.rate-control.create': {
        ...
        handler: async (_client: any, args: any) => this.createRateControl(args)
      },
      'security.rate-control.list': {
        description: 'List all rate control policies',
        inputSchema: PolicyContextSchema,
        handler: async (_client: any, args: any) => this.listResource(`security-policies/${args.policyId}/rate-controls`, args)
      },
      'security.rate-control.update': {
        ...
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/rate-controls/${args.rateControlId}`, args)
      },
      'security.rate-control.delete': {
        ...
        handler: async (_client: any, args: any) => this.deleteResource(`security-policies/${args.policyId}/rate-controls/${args.rateControlId}`, args)
      },
      'security.slow-ddos.configure': {
        description: 'Configure Slow DDoS protection settings',
        inputSchema: SlowDDoSSchema,
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/slow-ddos`, args)
      },
      ...
      'security.api.constraints.configure': {
        ...
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/api-constraints`, args)
      },
      'security.api.request-constraints.configure': {
        ...
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/api-request-constraints`, args)
      },
      'security.api.definition.upload': {
        ...
        handler: async (_client: any, args: any) => this.createResource('api-definitions', args)
      },
      'security.api.definition.list': {
        description: 'List all uploaded API definitions',
        inputSchema: ConfigVersionSchema,
        handler: async (_client: any, args: any) => this.listResource('api-definitions', args)
      },
      ...
      'security.custom-rule.create': {
        ...
        handler: async (_client: any, args: any) => this.createCustomRule(args)
      },
      'security.custom-rule.list': {
        description: 'List all custom security rules',
        inputSchema: PolicyContextSchema,
        handler: async (_client: any, args: any) => this.listResource(`security-policies/${args.policyId}/custom-rules`, args)
      },
      'security.custom-rule.update': {
        ...
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/custom-rules/${args.ruleId}`, args)
      },
      'security.custom-rule.delete': {
        ...
        handler: async (_client: any, args: any) => this.deleteResource(`security-policies/${args.policyId}/custom-rules/${args.ruleId}`, args)
      },
      'security.match-target.create': {
        description: 'Create advanced match target configuration',
        inputSchema: MatchTargetAdvancedSchema,
        handler: async (_client: any, args: any) => this.createResource('match-targets', args)
      },
      'security.match-target.list': {
        description: 'List all match targets for configuration',
        inputSchema: ConfigVersionSchema,
        handler: async (_client: any, args: any) => this.listResource('match-targets', args)
      },
      ...
      'security.network-list.geo.configure': {
        ...
        handler: async (_client: any, args: any) => this.updateResource(`network-lists/${args.networkListId}/geo`, args)
      },
      'security.network-list.asn.configure': {
        description: 'Configure ASN-based network list controls',
        inputSchema: NetworkListASNSchema,
        handler: async (_client: any, args: any) => this.updateResource(`network-lists/${args.networkListId}/asn`, args)
      },
      ...
      'security.reputation.configure': {
        ...
        handler: async (_client: any, args: any) => this.updateResource(`security-policies/${args.policyId}/reputation-profiles/${args.context}`, args)
      },
      'security.reputation.list': {
        description: 'List all reputation profiles',
        inputSchema: PolicyContextSchema,
        handler: async (_client: any, args: any) => this.listResource(`security-policies/${args.policyId}/reputation-profiles`, args)
      }
