 ...
 */
export class IncludeOperations extends AkamaiOperation {
  ...
  async listIncludes(args: z.infer<typeof ListIncludesSchema>): Promise<MCPToolResponse> {
    ...
    return this.executeStandardOperation(
      ...
      async (client) => {
        ...
        return {
          includes: (response as any).includes.items,
          count: (response as any).includes.items.length,
          message: `Found ${(response as any).includes.items.length} includes`
        };
      },
      {
  ...
  async createInclude(args: z.infer<typeof CreateIncludeSchema>): Promise<MCPToolResponse> {
    ...
    return this.executeStandardOperation(
      ...
      async (client) => {
        ...
        return {
          includeId,
          includeLink: (response as any).includeLink,
          includeName: params.includeName,
          includeType: params.includeType,
  ...
  async createIncludeVersion(args: z.infer<typeof CreateIncludeVersionSchema>): Promise<MCPToolResponse> {
    ...
    return this.executeStandardOperation(
      ...
      async (client) => {
        ...
        const newVersion = parseInt((response as any).versionLink.split('/').pop() || '0');

        return {
          includeId: params.includeId,
          newVersion,
          versionLink: (response as any).versionLink,
  ...
  async activateInclude(args: z.infer<typeof ActivateIncludeSchema>): Promise<MCPToolResponse> {
    ...
    return this.executeStandardOperation(
      ...
      async (client) => {
        ...
        const activationId = (response as any).activationLink.split('/').pop();
        ...
        return {
          ...
          network: params.network,
          activationId,
          activationLink: (response as any).activationLink,
  ...
  async listIncludeActivations(args: {
    ...
    return this.executeStandardOperation(
      ...
      async (client) => {
        ...
        return {
          includeId: params.includeId,
          activations: (response as any).activations.items,
          count: (response as any).activations.items.length,
          message: `Found ${(response as any).activations.items.length} activations for include ${params.includeId}`
        };
      },
      {
        customer: params.customer,
  ...
  async getIncludeActivationStatus(args: {
    ...
    return this.executeStandardOperation(
      ...
      async (client) => {
        ...
        const activation = (response as any).activations.items[0];
        if (!activation) {
...
export const includeOperations = new IncludeOperations();
export const includeTools = includeOperations; // @deprecated - use includeOperations