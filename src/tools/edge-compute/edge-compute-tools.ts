...
function formatEdgeWorkersList(response: EdgeComputeResponse): string {
  const edgeWorkerIds = response.edgeWorkerIds || [];
 ...
 */
export async function uploadEdgeWorkerVersion(args: z.infer<typeof EdgeComputeToolSchemas.uploadEdgeWorkerVersion>): Promise<MCPToolResponse> {
  return BaseTool.execute(
    'edge-compute',
    ...
    async (client) => {
      ...
      await client.request({
        method: 'PUT',
        path: EdgeWorkersEndpoints.uploadBundle(args.edgeWorkerId, version as string),
        body: args.bundle,
        headers: {
      ...
      return { ...createResponse, bundleUploaded: true };
    },
    {
      format: 'text',
...
export async function activateEdgeWorker(args: z.infer<typeof EdgeComputeToolSchemas.activateEdgeWorker>): Promise<MCPToolResponse> {
  return BaseTool.execute(
    ...
    async (client) => {
      return client.request({
        method: 'POST',
        path: EdgeWorkersEndpoints.activate(args.edgeWorkerId),
        body: {
    ...
    {
      format: 'text',
      formatter: (result) => formatActivationResponse(result, 'EdgeWorker'),
      progress: true
    }
  );
}
 ...
 */
export async function listCloudletsPolicies(args: z.infer<typeof EdgeComputeToolSchemas.listCloudletsPolicies>): Promise<MCPToolResponse> {
  return BaseTool.execute(
    'edge-compute',
    ...
    {
      format: 'text',
      formatter: (result) => formatCloudletsPoliciesList(result, args.cloudletType),
...
export async function activateCloudletPolicy(args: z.infer<typeof EdgeComputeToolSchemas.activateCloudletPolicy>): Promise<MCPToolResponse> {
  return BaseTool.execute(
    ...
    {
      format: 'text',
      formatter: (result) => formatActivationResponse(result, 'Cloudlet'),
      progress: true
    }
  );
}
