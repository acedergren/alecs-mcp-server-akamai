...
export const BillingSchemas = {
  ...
  NotificationPreferences: z.object({
    ...
    paymentDueAlerts: z.boolean().optional(),
    paymentReceivedAlerts: z.boolean().optional(),
    thresholdAlerts: z.boolean().optional(),
    thresholdSettings: z.object({
      amount: z.number(),
      currency: z.string(),
      type: z.string()
    }).optional(),
...
export const BillingResponseSchemas = {
  ...
  ProductUsageResponse: z.object({
    products: z.array(BillingSchemas.ProductUsage),
  ...
  // Contract usage response
  ContractUsageResponse: z.object({
    contracts: z.array(BillingSchemas.ContractUsage),
    total: z.number().optional()
  }),
  
  // Reporting group usage response
  ReportingGroupUsageResponse: z.object({
    reportingGroups: z.array(BillingSchemas.ReportingGroupUsage),
    total: z.number().optional()
  }),
  
  // CP code usage response
  CpCodeUsageResponse: z.object({
    cpcodes: z.array(BillingSchemas.CpCodeUsage),
    total: z.number().optional()
  }),
  
  // Invoice list response
  InvoiceListResponse: z.object({
    invoices: z.array(BillingSchemas.Invoice),
    pagination: z.object({
      total: z.number(),
      limit: z.number(),
      offset: z.number()
  ...
  EstimateListResponse: z.object({
    estimates: z.array(BillingSchemas.Estimate),
    total: z.number().optional()
  })
};
