...
export const staticWebsiteTemplate: PropertyTemplate = {
  id: 'static-website',
  name: 'Static Website',
  description: 'Optimized for static websites with HTML, CSS, JS, and images. Includes aggressive caching, compression, and HTTP/2 optimization.',
  category: 'web',
  requiredInputs: [
    {
      key: 'hostname',
  ...
  optionalInputs: [
    ...
    },
    {
      ...
      options: [
        { value: 'aggressive', label: 'Aggressive (30 days)', description: 'Maximum performance, requires cache busting for updates' },
        { value: 'standard', label: 'Standard (7 days)', description: 'Good balance of performance and freshness' },
        { value: 'conservative', label: 'Conservative (1 day)', description: 'More frequent origin checks' }
      ]
    },
    {
            ...
            criteria: [
              {
                ...
                options: {
                  ...
                  values: ['text/*', 'application/javascript', 'application/x-javascript', 'application/json', 'application/xml']
                }
              }
            ],
            behaviors: [
            ...
            criteria: [
              {
                ...
                options: {
                  matchOperator: 'IS_ONE_OF',
                  values: ['jpg', 'jpeg', 'png', 'gif', 'webp', 'css', 'js', 'woff', 'woff2', 'ttf', 'eot', 'svg', 'ico']
                }
              }
            ],
            behaviors: [
            ...
            behaviors: [
              ...
              },
              {
                ...
                options: {
                  behavior: 'IGNORE',
                  exactMatch: true,
                  parameters: ['utm_source', 'utm_medium', 'utm_campaign', 'utm_content', 'fbclid', 'gclid']
                }
              }
            ]
          }
...
export const dynamicWebApplicationTemplate: PropertyTemplate = {
  ...
  description: 'Optimized for modern web applications with API backends. Includes intelligent caching, API acceleration, and security headers.',
  category: 'web',
  requiredInputs: [
    {
      key: 'hostname',
...
export const apiAccelerationTemplate: PropertyTemplate = {
  id: 'api-acceleration',
  name: 'API Acceleration',
  description: 'Optimized for RESTful APIs and microservices. Includes rate limiting, authentication caching, and API-specific optimizations.',
  category: 'api',
  requiredInputs: [
    {
      key: 'hostname',
