...
/**
 * Enhanced WebSocket transport options
 */
 ...
 */
export class EnhancedWebSocketTransport implements Transport {
  ...
  // Rate limiting cache
  private rateLimitCache = new EnhancedSmartCache<number>({
    maxSize: 10000,
  ...
  private readonly options: Required<EnhancedWebSocketOptions>;
    ...
    try {
      ...
      await new Promise<void>((resolve, reject) => {
        this.httpServer!.listen(this.options.port, this.options.host, () => {
          logger.info('Enhanced WebSocket server listening', {
  ...
  async close(): Promise<void> {
    logger.info('Closing enhanced WebSocket server');
